...
print("--- 🚀 BOTAS STARTUOJA (Original Version Restored) ---")
...
# Naudojame stabilų modelį, kad nebūtų 404
...
def run_wealth_bot(politician_name):
    ...
    # Tavo originalus promptas su skaičių ir istorijos pataisymais
    prompt = (
        f"Write a 1000-word financial case study on {politician_name} for 2026. \n"
        f"1. Job Title: Precise current office. \n"
        f"2. Net Worth: If >= $1M use '$X.X Million', if < $1M use full number '$850,000'. \n"
        f"3. History: Provide annual values for 2018, 2019, 2020, 2021, 2022, 2023, 2024, 2025, 2026. \n"
        ...
        f"\"urls\": [\"URL1\"], \"wealth_sources\": [\"Real Estate Holdings\"], \"assets\": \"Top 2 major assets\", "
